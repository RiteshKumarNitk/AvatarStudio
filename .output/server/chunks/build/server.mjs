...
const _routes = [
  ...
  },
  {
    ...
    component: () => import('./studio-CCbcKm9h.mjs')
  },
  {
    name: "index",
    path: "/",
...
function createHeadComponentCtx() {
  ...
  const ctx = { input, entry: entry2, update: () => entry2.patch(input) };
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_Html, _attrs, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_Body, { class: "bg-[var(--color-bg)] text-[var(--color-text)] antialiased" }, {
        ...
        return [
          createVNode(_component_Body, { class: "bg-[var(--color-bg)] text-[var(--color-text)] antialiased" }, {
            default: withCtx(() => [
              createVNode(_component_NuxtLayout, null, {
                default: withCtx(() => [
                  createVNode(_component_NuxtPage)
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-Bit7udOc.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-D8N1t3_V.mjs'));
